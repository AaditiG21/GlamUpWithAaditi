...
public class GlamUpwithAaditi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        makeuppnlLayout.setHorizontalGroup(
            ...
            .addGroup(makeuppnlLayout.createSequentialGroup()
     ...
     private void Loginpnl(String panelName) {
       ...
       private void initializeDataMakeup(){
        ...
        registerMakeup(new MakeupModel(1234, "Lipstick", "Mocha", 10,"Mac", 6000, "","2023 August","2026 September" ));
        registerMakeup(new MakeupModel(1256, "Concealer", "beige", 8,"Milani", 12000,"","2023 april","2025 November")) ;
        registerMakeup(new MakeupModel(1267, "Blush", "red wine", 3 ,"wet n wild", 1800,"","2023 july","2029 May"));
        registerMakeup(new MakeupModel(1289, "Gloss", "red ", 3 ,"LA girl", 1400,"","2023 April","2028 May"));
        registerMakeup(new MakeupModel(1367, "Mascara", "black", 6 ,"Maybelline", 1600,"","2020 July","2024 June"));
       ...
       private void initializeDataFragnance(){
        ...
        registerFragnance(new FragnanceModel(1221, "Vanilla","vanilla essence", 2 ,"Chanel", 6000,"2023 January","2024 June" ));
        registerFragnance(new FragnanceModel(1234, "Strawberry","strawberry essence",4 ,"SO", 1000,"2024 April","2024 April" ));
        registerFragnance(new FragnanceModel(1256, "Chocolate","alcohol", 6 ,"Versace", 1039,"2022 June","2024 May" ));
        registerFragnance(new FragnanceModel(1399, "coco","alcohol", 6 ,"Versace", 1078,"2021 July","2024 August" ));
        registerFragnance(new FragnanceModel(1286, "happy","alcohol", 6 ,"Versace", 1099,"2023 August","2024 April" ));
